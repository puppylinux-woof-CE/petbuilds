...
for ONEOPEN in Abiword Bcrypt ePDFView FFConvert Firefox Geany gedit evince gpicview mtpaint Ghasher Ghostview Gnumeric Gxine HomeBank InkLite Inkscape Pburn ISOMaster Leafpad Mozilla-Firefox mhWaveEdit Notecase Opera Planner Pmusic PupZip SeaMonkey-Composer SeaMonkey-web-browser Viewnior XArchive
do
